package com.beauty.mhzc.core.storage.config;


import com.beauty.mhzc.core.storage.*;
...
public class StorageAutoConfiguration {
    ...
    @Bean
    public GenericStorageService genericStorageService() {
        GenericStorageService genericStorageService = new GenericStorageService();
        String active = this.properties.getActive();
        genericStorageService.setActive(active);
        if (active.equals("local")) {
            genericStorageService.setGenericStorage(localStorage());
        } else if (active.equals("aliyun")) {
            genericStorageService.setGenericStorage(aliyunStorage());
        } else if (active.equals("tencent")) {
            genericStorageService.setGenericStorage(tencentStorage());
        } else if (active.equals("qiniu")) {
            genericStorageService.setGenericStorage(qiniuStorage());
        } else {
